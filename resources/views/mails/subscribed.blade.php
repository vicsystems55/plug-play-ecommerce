          ...
          <td class="center-text" data-text-style="Paragraphs" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
              <singleline>
                <div mc:edit data-text-edit>
                  ...
                  <h3><span> Sellers' Dashboard</span></h3>
                  <h3><span> Update your bank details</span></h3>
                  <h3><span> Receive reports on store performance and lots more...</span></h3>


                  <p>Your subscription for {{$data['subscription_name']}} has been activated and will expire on {{$data['end_date']}}</p>



                  If you have any questions, please contact our customer service team at +234 803 783 5670.
                </div>
              </singleline>
          </td>
        </tr>
